...
$(function () {
  ...
  const links = document.querySelectorAll(".headerTop__menuLink");
  ...
  if ($(".js-menu-btn-open").length) {
    $(".js-menu-btn-open").click(function (e) {
      e.preventDefault(e);
      $(".js-menu").toggleClass("m-active");
      $(".js-menu-overlay").toggleClass("m-active");
  ...
  if ($(".js-menu-overlay").length) {
    $(".js-menu-overlay").click(function (e) {
      ...
      $(".js-menu-overlay").removeClass("m-active");
      $("body").removeClass("is-navigation-open");
    });
  }

  if ($(".js-menu-close-btn").length) {
    $(".js-menu-close-btn").click(function (e) {
      e.preventDefault(e);
      $(".js-menu").removeClass("m-active");
      $(".js-menu-overlay").removeClass("m-active");
      $("body").removeClass("is-navigation-open");
